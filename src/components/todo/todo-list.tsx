    ...
    return (
        <>
            ...
            <View style={styles.todoListContainer} >
                <Button title='Add new Goal' color='#a065ec' onPress={() => setInputIsVisible(true)} />
                <TodoInput visible={inputIsVisible} onInsert={handleTodoInsert} onCancel={handleTodoCancel} />
